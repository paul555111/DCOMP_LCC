...
def task(filelist, pathin, pathout):    
    ...
    job_id = int(np.loadtxt(os.path.join('/Users/paul5/job_id','job_id.csv'), delimiter=','))
    ...
    job_id+=1
    np.savetxt(os.path.join('/Users/paul5/job_id', 'job_id.csv'), np.asarray([job_id]), delimiter=',')
    
    
if __name__ == '__main__': ##THIS IS FOR TESTING - DO THIS
    filelist= ['fireengine'+str(i+1)+'_20200424.jpg' for i in range(20)] 
    task(filelist,'/Users/paul5/fireengine', '/Users/paul5/Enc_Data') 
